...
class Config:
    ...
    # GPU 타입별 설정
    GPU_TYPES = {
        "H100-80GB": {"memory_gb": 80, "cores": 100, "priority_weight": 1.0},
        "A100-80GB": {"memory_gb": 80, "cores": 100, "priority_weight": 0.8},
        "A100-40GB": {"memory_gb": 40, "cores": 100, "priority_weight": 0.6},
    }
